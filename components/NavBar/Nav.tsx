      ...
      >
        <div className="text-white flex items-center h-full justify-between w-[90%] xl:w-[87%] mx-auto">
          ...
          <div className="hidden md:flex items-center gap-6 text-sm">
            ...
            <div
              className={`flex items-center gap-1 cursor-pointer pb-1 ${
                router.pathname === "/services"
                  ? "border-b-2 border-[#7D0101]"
                  : ""
              }`}
            ...
            <div className="relative" ref={categoryRef}>
              ...
              {showCategories && (
                <div className="absolute top-full right-0 mt-4 w-[450px] bg-white text-black shadow-lg rounded-md grid grid-cols-2 gap-1 p-4 z-50">
            ...
            <div className="relative" ref={helpRef}>
              ...
              {showHelp && (
                <div className="absolute top-full left-0 mt-4 w-[350px] bg-white text-black shadow-lg rounded-md grid grid-cols-2 gap-1 p-4 z-50">
...
//             <div
//               className={`flex items-center gap-1 cursor-pointer pb-1 ${
//                 router.pathname === "/services" ? "border-b-2 border-[#7D0101]" : ""
//               }`}
//               onClick={() => router.push("/services")}
//             >
//               <span>Services</span>
